...
DOTween must be imported separately from the [Asset Store](http://dotween.demigiant.com/) or as a `.unitypackage`.
...
Assing GameLiftLifetimeScope prefab in Prefabs to VContainerSettings RootLifetimeScope field

### Step 2: Configure ScriptableObjects

Create the required settings assets via **Assets > Create** or by duplicating the ones provided in the Samples folder:
